...
},
{
  ...
  sites:[
    ...
    { plate:"EUR", lon:-1.5, lat:53.5, cat:"forest",
      ...
      body:"The coal measures are cycles of sandstone, shale, seatearth and coal, repeated dozens of times as sea level rose and fell with the southern ice sheet, about 310 million years ago. Each seam is a drowned equatorial forest of lycopsid trees up to fifty metres tall, as high as a fifteen-storey building. The industrial towns of Yorkshire and the East Midlands were built on top of them.",
    ...
    { plate:"EUR", lon:3, lat:49.5, cat:"fossil",
      ...
      body:"Meganeura was a dragonfly relative with a wingspan of about 70 centimetres, and the millipede relative Arthropleura reached two and a half metres. Both lived about 300 million years ago. Insects breathe by diffusion through tubes, so the oxygen in the air limits their size, and at roughly 30 percent oxygen that ceiling lifts. They shared a humid equatorial forest with no flying vertebrates to compete with. The fossils come from the old coal basin of northern France and Belgium.",
...
},
{
  ...
  sites:[
    { plate:"ANT", lon:162, lat:-85, cat:"forest",
      ...
      body:"Fossil tree trunks and leaf mats of Glossopteris occur in the Transantarctic Mountains, in rock about 260 million years old. The forest grew within about 20° of the South Pole, dark for months at a time. Glossopteris dropped its leaves for the polar winter, and its growth rings are wide and end abruptly, the mark of a plant racing through a short, intense summer. The wood now weathers out of cliffs above a two-kilometre ice sheet.",
    ...
    { plate:"AFR", lon:24, lat:-32, cat:"fossil",
      ...
      body:"The Karoo Basin holds the thickest continuous record anywhere of life on land through the end-Permian extinction, 252 million years ago. Below the boundary the rock is full of dicynodonts and other therapsids, mammal ancestors with differentiated teeth; above it, for millions of years, almost the only large animal is the stocky survivor Lystrosaurus. The animals lived on a cool river plain at about 60° south that dried out as the extinction approached. The rock now forms the flat-topped hills of the Great Karoo.",
    ...
    { plate:"SIB", lon:94, lat:69, cat:"event",
      ...
      body:"The Siberian Traps are a pile of lava that covered an area the size of Western Europe, erupted over roughly a million years around 252 million years ago. On its way up the lava burned through a thick basin of coal, salt and organic shale. The gases that came out, carbon dioxide and methane among them, acidified the oceans and warmed the planet, and the extinction followed. The lava now forms the stepped Putorana Plateau, cut by canyons and waterfalls.",
    ...
    { plate:"NAM", lon:-110, lat:38, cat:"event",
      ...
      body:"The Coconino and Cedar Mesa sandstones are dunes turned to stone, about 275 million years old. Their cross-bedding records wind directions, and small reptiles left trackways running up the dune faces. The dune field lay deep inside Pangaea, thousands of kilometres from any coast, and sandstones of the same age lie beneath the North Sea and much of northern Germany. On the Colorado Plateau the old dunes now stand as the pale band high in the walls of the Grand Canyon.",
...
},
{
  ...
  sites:[
    ...
    { plate:"NAM", lon:-109.8, lat:34.9, cat:"forest",
      ...
      body:"The Petrified Forest is whole conifer trunks up to fifty metres long, turned to quartz log by log about 220 million years ago. Iron and manganese colour the quartz that replaced the cell walls. The main tree, Araucarioxylon arizonicum, is a relative of the monkey puzzle, and big rivers carried its logs north-west across a warm humid lowland at about 15° north. The logs now lie in cold semi-desert at 1,700 metres, with no living tree for a hundred kilometres.",
...
},
{
  ...
  sites:[
    ...
    { plate:"EUR", lon:8.75, lat:49.9, cat:"fossil",
      ...
      body:"The Messel Pit preserves mammals complete with fur, gut contents and stomach bacteria, 47 million years old. Bats lie with their last meal identifiable to species, and horses the size of a fox terrier are preserved pregnant. The pit was a deep crater lake ringed by warm humid forest, with stagnant bottom water and occasional releases of gas that killed animals at the surface. It is now an abandoned oil-shale quarry near Darmstadt in Hesse.",
...
},
{
  ...
  title:"Mesosaurus",
  body:"The Irati Formation of southern Brazil and Uruguay holds Mesosaurus, a freshwater reptile about a metre long, in Early Permian rock. The Whitehill Formation of Namibia and South Africa holds the same animal in rock of the same age, and it is found nowhere else. It was too small a swimmer to cross an ocean. The two basins lay side by side in the interior of Gondwana, so the match is inherited.",
  places:[
...
},
{
  ...
  title:"Glossopteris",
  body:"Coalfields in Brazil, South Africa, Madagascar, India, Australia and Antarctica all carry Glossopteris, a Permian seed fern with tongue-shaped leaves. Its seeds were too large to travel far on the wind. The plant spread over land that was joined at the time, so the match is inherited. Its coal is mined today in the tropics and the desert, and it outcrops beside polar ice.",
  places:[
...
},
{
  ...
  body:"Southern beech (Nothofagus) grows in Chile, Tasmania, New Zealand and New Guinea, and its fossil leaves occur on the Antarctic Peninsula. Its seeds die in salt water. The forests were continuous across southern Gondwana in the Cretaceous and were carried apart as it broke up, so the match is inherited.",
  places:[
...
},
{
  ...
  body:"The Coconino Sandstone of Arizona, the Penrith Sandstone of northern England and the Buntsandstein of Germany are desert sandstones of Permian and Triassic age. In each, the grains are rounded and frosted by wind and coated in iron oxide. All three formed in one desert belt in the interior of Pangaea, so the match is inherited.",
  places:[
...
const COLUMNS = [
{
  ...
  layers:[
    ...
    { name:"Hermit Shale", age:"Permian", period:"per", lith:"shale", m:90,
      env:"Soft red siltstone and mudstone with fern and conifer fossils. A river floodplain laid it down.",
      thick:"About 90 m" },
    ...
    { name:"Claron Formation", age:"Paleogene", period:"pgn", lith:"limestone", m:300,
      env:"Pink and white limestone with mudstone. It settled in lakes and streams on a high basin floor, and it weathers into the hoodoos of Bryce Canyon.",
      thick:"Up to 300 m" }
  ]
},
{
  ...
  layers:[
    { name:"Old Red Sandstone", age:"Devonian", period:"dev", lith:"sandstone", m:500,
      env:"Red and purple sandstone with pebble beds. Rivers carried it south from the new Caledonian mountains across a desert near the equator.",
    ...
    { name:"Wealden beds", age:"Early Cretaceous", period:"cre", lith:"shale", m:800,
      env:"Sand and clay in thick alternating units. Rivers spread them over a plain where Iguanodon lived, a dinosaur first described from bones found in Sussex.",
