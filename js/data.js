...
const PERIODS = [
{
  ...
  sites:[
    { plate:"NAM", lon:-116.5, lat:51.4, cat:"fossil",
      ...
      sources:[100,484,485,486,487,488],
    ...
    { plate:"CHI", lon:102.6, lat:24.7, cat:"fossil",
      ...
      body:"Chengjiang's fossils include Myllokunmingia and Haikouichthys, finger-length swimmers with a stiffening rod down the back, which places them close to the ancestry of all vertebrates. The beds are 518 million years old, ten million years older than the Burgess Shale. They formed on the front of a delta off a small continent drifting alone in the eastern ocean, where river floods driven by ocean storms buried the animals again and again. The rock now forms red-earth hills above Fuxian Lake in Yunnan.",
      sources:[105,108,484,489,490,491],
      then:{ where:"Shallow tropical shelf", icon:"sea",
             text:"A delta front on a small isolated block, repeatedly buried by storm-driven river floods." },
    ...
    { plate:"ANT", lon:160, lat:-84, cat:"fossil",
      ...
      now:{ where:"Transantarctic Mountains", icon:"ice",
            text:"Exposed rock and ice, roughly 870 km from the South Pole. Antarctica has two native flowering plants in total, both on the peninsula, and neither grows anywhere near here." } },
...
},
{
  ...
  sites:[
    ...
    { plate:"AFR", lon:56, lat:21, cat:"forest",
      ...
      body:"Tough spore clusters in groups of four turn up in Ordovician rock in Oman, long before any recognisable plant fossil. The spores match what liverworts produce, and in Oman they sit inside sporangia. That is the first direct evidence that the spores came from plants growing on land. The plants grew as low mats on wet sand and rock, none taller than a coin is wide. The rock now lies under the desert and gravel plains of Oman.",
      sources:[292],
...
},
{
  ...
  sites:[
    ...
    { plate:"EUR", lon:17, lat:57.5, cat:"event",
      ...
      body:"The Caledonian mountains rose about 425 million years ago, where Baltica swung into Laurentia and squeezed the Iapetus Ocean shut. The belt stood as high as the Himalaya does now, at about 30° south, and shed sand into basins on either side. Cocks and Torsvik (2005) have Iapetus already closed at this moment, while this globe still draws about 20 degrees of water between Newfoundland and Scotland, so the collision reads as further off here than in their reconstruction. Its eroded roots now lie in four places that used to be continuous: the Scottish Highlands, the Norwegian mountains, eastern Greenland and the northern Appalachians.",
      sources:[311,358,359,363,509],
...
},
{
  ...
  sites:[
    { plate:"NAM", lon:-74.4, lat:42.4, cat:"forest",
      ...
      body:"The Gilboa forest is a stand of fossil tree stumps still rooted where they grew, 386 million years old. Quarrying for a dam in 1920 uncovered hundreds of them. They belong to Eospermatopteris, a tree shaped like a giant celery stalk with a flared base and a crown of branches in place of leaves, and a nearby site at Cairo preserves Archaeopteris root systems more than eleven metres across. The trees grew on a humid floodplain at about 30° south that floods buried again and again. The stumps now sit in Catskill hill country in Schoharie County, New York.",
      sources:[2,418,419,507,508,515],
      then:{ where:"River plain at about 30° south", icon:"fern",
    ...
    { plate:"EUR", lon:-2.8, lat:57.4, cat:"fossil",
      ...
      body:"The Rhynie chert is an entire ecosystem turned to stone cell by cell, 407 million years ago. A hot spring flooded a marshy plain with silica-rich water, and the chert preserves individual plant cells, fungal threads inside roots, springtails, mites and a pair of jaws that may be the oldest known insect. Low tufted plants grew around silica-crusted pools on a dry rift floor. Wellman (2018) places Rhynie at about 25° south; this globe draws it at about 9° south, a gap that sits inside the spread between published reconstructions. The chert now lies under flat farmland in Aberdeenshire.",
      sources:[13,509,510,511],
      then:{ where:"Hot springs on an arid rift floor", icon:"moss",
             text:"Low tufted plants around silica-crusted pools, in a dry basin at about 25° south." },
...
},
{
  ...
  sites:[
    ...
    { plate:"EUR", lon:11, lat:48.9, cat:"fossil",
      ...
      body:"The Solnhofen limestone preserves feathers, jellyfish and insect wings, and most of the twelve known skeletons of Archaeopteryx. Two of the twelve came from neighbouring limestones of slightly different age. It is about 150 million years old, and so fine-grained that it was used for lithographic printing. It settled in oxygen-starved lagoons between reef islands in the Tethys at about 30° north, where nothing could scavenge a carcass. The quarries in the Altmühl valley of Bavaria still work it.",
      sources:[164,467],
...
},
{
  ...
  body:[
    "From 143 to 66 million years ago Gondwana comes apart. South America separates from Africa and the South Atlantic opens from the south upward like a zip, while India breaks away and moves north at up to 20 centimetres a year, several times the pace of Africa or Australia, leaving Madagascar behind.",
  ...
  sites:[
    ...
    { plate:"IND", lon:76, lat:18, cat:"event",
      ...
      body:"India broke from Madagascar around 88 million years ago and crossed the Tethys as an island continent. It moved north at up to 20 centimetres a year, roughly five times the rate a fingernail grows. Its plants and animals evolved in isolation for tens of millions of years, and its rivers held ancestors of the frogs and caecilians still found only in the Western Ghats. That ground is now the Deccan plateau.",
      sources:[435,479],
...
},
{
  ...
  sites:[
    ...
    { plate:"IND", lon:78, lat:30, cat:"event",
      ...
      body:"The northern edge of India met the southern edge of Asia between about 55 and 50 million years ago. Neither could sink, so both crumpled, and the last of the Tethys was squeezed out between them. Ordovician limestone laid down on the northern edge of India now sits at the summit of Everest, carrying trilobite and crinoid debris at 8,800 metres. The mountains still rise about a centimetre a year.",
      sources:[331,472,479],
    ...
    { plate:"NAM", lon:-110, lat:41.5, cat:"forest",
      ...
      body:"The Green River Formation is paper-thin annual layers laid down in three large lakes over millions of years, about 50 million years ago. Fossil palms, crocodiles and stingrays come out of them, alongside twenty-seven species of fish preserved whole. The lakes were warm and subtropical, fringed with palm and sycamore and ringed by rising mountains. The basin is now cold high desert above 2,000 metres in Wyoming, Utah and Colorado.",
      sources:[462,481],
...
},
{
  ...
  sites:[
    { plate:"SAM", lon:-72.5, lat:-41.5, cat:"forest",
      ...
      body:"Southern beech (Nothofagus) grows in Chile, Argentina, New Zealand, Tasmania, mainland Australia, New Guinea and New Caledonia, and nowhere else. Its seeds are heavy and travel poorly. The same lineage grew across southern Gondwana, Antarctica included, while the pieces were joined, and its range today maps the continent that broke up around it. In Chile it grows in the Valdivian rainforest, under two to four metres of rain a year.",
      sources:[370,478],
      ...
      now:{ where:"Los Ríos and Los Lagos, Chile", icon:"broadleaf",
            text:"Cool temperate rainforest of coigüe, ulmo and alerce, with two to four metres of rain a year and a fern and bamboo understorey." } },
    ...
    { plate:"ANT", lon:0, lat:-90, cat:"ice",
      ...
      body:"The ice at the geographic South Pole is about 2,700 metres thick, and the bedrock beneath lies near sea level. The ice core drilled beside the station holds a continuous record of the atmosphere back to about 54,000 years ago, in air bubbles that can be sampled directly. This continent carried Glossopteris forest in the Permian and beech and conifer rainforest in the Cretaceous. Nothing grows here now, and the nearest plants are mosses on the peninsula, 2,000 kilometres away.",
      sources:[439,473,482,483],
