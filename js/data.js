...
},
{
  ...
  title:"Mesosaurus",
  body:"The Irati Formation of southern Brazil and Uruguay holds Mesosaurus, an aquatic reptile usually under a metre long, in Early Permian rock. The Whitehill Formation of Namibia and South Africa holds the same animal in rock of the same age, and it is found nowhere else. It was too small a swimmer to cross an ocean. The two basins lay side by side in the interior of Gondwana, so the match is inherited.",
  places:[
